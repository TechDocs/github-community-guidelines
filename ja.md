...
GitHubコミュニティ第一の目的は、ソフトウェアプロジェクトで協力することです。私たちは人々が一緒に働きやすいことを望んでいます。私たちはサイトを保守しますが、これは私たちが共につくるコミュニティであり、可能な限り良いものにするため、みなさんの助けを必要としています。
...
- **歓迎と開かれた気持ちで** - 他の協力者たちはあなたと同等の経験やバックグラウンドを持たないかもしれませんが、それだからといって、彼らがコントリビュートするのに良いアイデアを持たないことを意味するわけではありません。私たちは、プロジェクトとディスカッションに新しい協力者を歓迎することを奨励します。
...
- **トピックから離れない** - GitHubを使うのは、仕事を完成させるため、もっと生産的になるためです。トピックからはずれたコメントは、その邪魔になります (ときには、歓迎されることもありますが、大抵はそうではありません)。トピックに集中することは、ポジティブで生産的なディスカッションを作り出すのを助けます。
...
- **論点をクリアーに** - インターネット上で、見ず知らずのひととコミュニケートすると、気まずい状態になることもあります。意図を読んだり伝えたりすることは難しく、きつい言葉は誤解されがちです。クリアな言葉を使うように心がけて、他のひとにどのように受け取られるかを考えてください。
